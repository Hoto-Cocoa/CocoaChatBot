...
module.exports = class GoogleSearch {
	 ...
	 */
	constructor(maxResultCount = 10) { this.maxResultCount = maxResultCount; }
	...
	async getResult(searchValue = '') {
		return new Promise(async (resolve, reject) => {
			const $ = require('cheerio').load(await require('./AsyncRequest')(`https://www.google.com/search?hl=en&q=${encodeURI(searchValue)}&sa=N&num=${this.maxResultCount}&ie=UTF-8&oe=UTF-8&gws_rd=ssl`).catch(e => reject(e)));
			var result = [];
			$('div.g').each((i, e) => {
